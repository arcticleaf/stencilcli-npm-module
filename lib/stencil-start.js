...
class StencilStart {
    ...
    async run(cliOptions) {
        ...
        if (cliOptions.disableBS === true && this._buildConfigManager.production) {
            // bypass startBrowserSync and development mode, uses production mode
            this._buildConfigManager.initWorker().production(() => {
